...
export interface TallyNonQvInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface TallyNonQv extends BaseContract {
  connect(runner?: ContractRunner | null): TallyNonQv;
  waitForDeployment(): Promise<this>;

  interface: TallyNonQvInterface;
