...
export interface TallyNonQvFactoryInterface extends Interface {
...
export interface TallyNonQvFactory extends BaseContract {
  connect(runner?: ContractRunner | null): TallyNonQvFactory;
  waitForDeployment(): Promise<this>;

  interface: TallyNonQvFactoryInterface;
