...
export interface SubsidyFactoryInterface extends Interface {
...
export interface SubsidyFactory extends BaseContract {
  connect(runner?: ContractRunner | null): SubsidyFactory;
  waitForDeployment(): Promise<this>;

  interface: SubsidyFactoryInterface;
